...
namespace BuildingAndFreezerApp.Controllers
{
    ...
    public class ReportsBuildingController : Controller
    {
        ...
        public ActionResult DetailsOneMatrial(int? id, int buildId)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            repositry.BuildingMatrial = repositry.BuildingMatrial.Where(x => x.BuildID == buildId && x.MatID == id);
            return View(repositry);
        }
        ...
        public ActionResult DetailsOneEmployee(int? id, int buildId)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            repositry.BuildingEmployee = repositry.BuildingEmployee.Where(x => x.BuildID == buildId && x.empID == id);
            return View(repositry);
        }
        ...
        public ActionResult DetailsOneNonworks(int? id, int buildId)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            repositry.NonWorks = repositry.NonWorks.Where(x => x.BuildID == buildId && x.NonId == id);
            return View(repositry);
        }
